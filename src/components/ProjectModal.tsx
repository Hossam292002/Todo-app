    ...
    <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 backdrop-blur-sm" onClick={onClose}>
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="mb-1 block text-sm font-medium text-slate-900 dark:text-slate-200">Project ID * (unique)</label>
            <input
              type="text"
              value={id}
          ...
          <div>
            <label className="mb-1 block text-sm font-medium text-slate-900 dark:text-slate-200">Name *</label>
            <input
              type="text"
              value={name}
